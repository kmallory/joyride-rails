...
Gem::Specification.new do |s|
  ...
  s.authors     = ['Michael North', 'Loqman']
  s.email       = %w(michael.north@truenorthapps.com)
  s.homepage    = 'https://github.com/loqman/joyride-rails'
  ...
  s.add_development_dependency 'sass-rails', '~> 4.0.0.rc2'
